...
// import sp1 from "./../../assets/20.png";

// const SingleDoors = () => {
//   const[product,setProduct]=useState({});
//   return (
//     <Container className="product-view mt-4">
...
//           <Typography className="text-lg text-black" variant="h3">Single Door #AI06</Typography>
//           <Typography className="text-md font-medium ">₹10000 </Typography>
//           <Grid item xs={12} md={8} className='mr-0 mt-2'>
...
//             }}
//               size="large"
//               className="bg-transparent mt-4 hover:bg-blue-500 text-slate-600 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded"
//             >
//             Add To Cart
//             </button>
//           </Grid>
      ...
      <Wrapper>
        ...
        <Container>
          ...
          <Desc className="text-lg text-black">
            Amso Wrought Iron Wine Cellar Single Door Gate - Many sizes to
            choose from
          </Desc>
          <Price>₹10000</Price>
