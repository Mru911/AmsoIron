...
const Slides = [
  ...
  {
    title: "Turn your thoughts into reality",
    bg: Img2,
  ...
  return (
    ...
    className="heroSlider h-[500px] lg:h-[560px] bg">
      {Slides.map((slide, index) => {
        ...
        return (
          <SwiperSlide
            className="h-full bg-slate-200 relative flex justify-center items-center"
            key={index}
          >
            <div className="z-20 text-white text-center">
              ...
              <h1 className="text-[32px] uppercase tracking-[2px] max-w-[920px] lg:text-[58px] font-serif leading-tight mb-6">
                {title}
              </h1>
              <button className="btn btn-lg btn-primary mx-auto cursor-pointer">{btnText}</button>
