       ...
       {/* <div className="hero-image rounded-xl ">
        ...
        <div className="main-image">
          <div className="containerc1">
            <h1><span>Contact Us For Your Specific Requirement</span></h1>
            <span className="cen">Its our pleasure to deliver the exact product you have imagined...</span>
            <a className="paymentBtn" href="/contact">Contact Us</a>
          </div>
        </div>
